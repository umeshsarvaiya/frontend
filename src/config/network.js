...
const config = {
  ...
  production: {
    apiUrl: process.env.REACT_APP_API_URL || 'http://10.45.137.92:5000',
    socketUrl: process.env.REACT_APP_SOCKET_URL || 'http://10.45.137.92:5000',
    frontendUrl: process.env.REACT_APP_FRONTEND_URL || 'http://10.45.137.92:3000'
  }
};
